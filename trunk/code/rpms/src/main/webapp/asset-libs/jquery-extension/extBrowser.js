...
if (browser.userAgent.indexOf('MSIE') > -1 || browser.userAgent.indexOf("Trident") > -1) {
	// IE浏览器
	browser.isIe = true;
    if (browser.userAgent.indexOf('Trident') > -1 && browser.userAgent.indexOf('rv:11') > -1) {
        // IE11
        browser.ieVersion = 11;
    } else if (browser.userAgent.indexOf('MSIE 10') > -1) {
		// IE10
