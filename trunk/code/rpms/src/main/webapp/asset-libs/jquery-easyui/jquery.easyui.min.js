...
return win;
},fullprogress:function(_fpoptions){ // full progress bar for bootstrap
var _1281={close:function(){
var win=$("body>div.messager-window>div.messager-body:has(div.messager-progress)");
if(win.length){
win.window("close");
}
}};
if(typeof _fpoptions=="string"){
var _1282=_1281[_fpoptions];
return _1282();
}
var opts=$.extend({title:"",msg:""},_fpoptions||{});
var _fprogressbar="<div class=\"messager-progress\"><div class=\"messager-p-msg\"></div><div class=\"progress progress-striped active\"><div class=\"progress-bar\" style=\"width: 100%;\"></div></div></div>";
var win=_271(opts.title,_fprogressbar,null);
win.find("div.messager-p-msg").html(opts.msg);
win.window({closable:false,onClose:function(){
$(this).window("destroy");
}});
return win;
}}; // full progress bar end
...
// set closed title
var _csdTitle;
var _closedTitle=_37a.closedTitle;
if(_closedTitle){_csdTitle=_closedTitle;}
else{_csdTitle='&nbsp;';}
// set closed title end
...
// set closed title
p.panel($.extend({},$.fn.layout.paneldefaults,{cls:("layout-expand layout-expand-"+dir),title:_csdTitle,closed:true,doSize:false,tools:[{iconCls:icon,handler:function(){
_381(_376,_377);
return false;
}}]}));
