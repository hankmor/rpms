...
<form id="animal-photo-upload-form" method="post" style="margin-top: 10px;" enctype="multipart/form-data">
    <table class="layout-table" cellpadding="4">
        <input type="hidden" name="animalId" id="photo-upload-animal-id" value="${animal.id}"/>
        <tr>
            <td style="text-align: right"><span style="color: red;">*</span>编号：</td>
            <td>
                <input style="width: 250px;" type="text" readonly class="easyui-validatebox"
                       data-options="required:true" value="${animal.tatooCode}">
            </td>
        </tr>
        <tr>
            <td style="text-align: right">呼名：</td>
            <td>
                <input style="width: 250px;" type="text" readonly class="easyui-validatebox" value="${animal.name}">
            </td>
        </tr>
        <tr>
...
<script type="text/javascript">
    $(function () {
        ...
        $('#animal-photo-upload-form').form({
            url: getContentPath() + '/rp/uploadPhoto.do',
            onSubmit: function () {
