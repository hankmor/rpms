...
<form id="exam-facade-upload-form" method="post" style="margin-top: 10px;" enctype="multipart/form-data">
    <table class="layout-table" cellpadding="4">
        <input type="hidden" name="examId" id="facade-exam-upload-id" value="${exam.id}"/>
        <tr>
...
<script type="text/javascript">
    $(function () {
        ...
        $('#exam-facade-upload-form').form({
            url: getContentPath() + '/exam/uploadFacade.do',
            onSubmit: function () {
