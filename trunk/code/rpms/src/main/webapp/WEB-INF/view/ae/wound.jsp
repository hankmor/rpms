...
<div class="easyui-layout" data-options="fit:true">
    <input type="hidden" id="exam-wound-id" value="${exam.id}">
    <div data-options="region:'center',title:'受伤照片列表',border:false">
            ...
            <table style="width: 100%">
                <tr>
                    ...
                    <td style="width: 20%;min-width: 170px;">
                        <a href="#" style="float: right" class="easyui-linkbutton" id="wound-upload"
                           data-options="iconCls:'icon-upload'">上传受伤情况照片</a>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div class="row" style="padding: 5px;">
            <c:if test="${fn:length(wounds) == 0}">
                <h2 style="color:#CCC;text-align: center;vertical-align: middle">暂无受伤情况数据.</h2>
            </c:if>
            <c:forEach items="${wounds}" var="p">
                <div class="col-sm-6 col-md-3 col-xs-3">
                    <input type="hidden" name="id" value="${p.id}">
                    <div class="thumbnail">
                        <img class="animal-photo" alt="${p.name}" src="${p.url}" style="height: 220px; width: 100%; display: block;cursor: pointer;">
                        <div class="caption">
...
<script type="text/javascript" src="${ctx}/assets/js/ae/wound.js" charset="utf-8"></script>
